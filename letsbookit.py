...
what does this do?
	object itself is a bookshelf(digital)
	gets user selection
		What is the selection?
		-Add book(1) #Adds books to bookshelf
		-Retreive book(2) #Retreives book (by title) from bookshelf 
		-Remove book(3) #Removes book from bookshelf 
		-display all(4) #Displays all books
		-exit program(5) #exits program(obviously)
"""
import sys
